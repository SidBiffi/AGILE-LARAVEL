  ...
  <div>
    ...
    <div class="p-wrapper">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <h2>Soci: aziende associate</h2>
            <table class="partner-table">
              <thead>
                <tr>
                  <th>Nome</th>
                  <th>Numero utenti</th>
                  <th>Numero filiali</th>
                  <th>Numero account</th>
                  <th>
                    <span class="em"></span>
                  </th>
                  <th>
              ...
              <tbody>
                <template v-for="partner in partners">
                  <tr>
                    <td>{{$niceField(partner.company_name)}}</td>
                    <td>1234</td>
                    <td>1234</td>
                    <td>1234</td>
                    <td>1234</td>
                    ...
                    <td>1234</td>
                    <td>
                      <a class="view" :href="'/partners/'+partner.id" title="Visualizza"></a>
                    </td>
                  </tr>
                </template>
              </tbody>
            </table>
            <p class="no-rows" v-if="partners.length==0">Non è stato trovato alcun socio, modifica i parametri di ricerca.</p>
  ...
  export default {
    ...
    methods: {
      ...
      getInitValues(type=null){
        ...
        axios.get('/api/partners', params).then(response => {
          ...
          if(obj && !obj.error){
            ...
            this.page_number = Math.ceil(obj.partners_count/this.limit);
