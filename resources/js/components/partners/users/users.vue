<template>
  <div>
    ...
    <div class="table-wrapper">
      ...
      <p class="no-rows" v-if="users.length==0">Non è stato trovato alcun utente, modifica i parametri di ricerca.</p>
  ...
  export default {
    ...
    methods: {
      ...
      getInitValues(type=null){
        ...
        axios.get('/api/partners/'+this.partner.id+'/users', params).then(response => {
          ...
          if(obj && !obj.error){
            ...
            this.page_number = Math.ceil(obj.users_count/this.limit);
